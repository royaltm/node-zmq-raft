...
class FramesProtocol {
  ...
  **/
  createRouterMessageListener(router, handler, context) {
    if (!router || 'object' !== typeof router) throw new TypeError("${this.name}: router must be an object");
    if ('function' !== typeof router.on) throw new TypeError("${this.name}: router must have `on' method");
  ...
  **/
  createSubMessageListener(sub, handler, context) {
    if (!sub || 'object' !== typeof sub) throw new TypeError("${this.name}: sub must be an object");
    if ('function' !== typeof sub.on) throw new TypeError("${this.name}: sub must have `on' method");
  ...
  **/
  createSendFunctionFor(pub) {
    if (!pub || 'object' !== typeof pub) throw new TypeError("${this.name}: pub must be an object");
