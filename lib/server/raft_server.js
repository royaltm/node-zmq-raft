...
exports.requestEntriesHandler = function(reply, prevIndex, count) {
  ...
  const pipe = () => {
    debug('pipe: nextIndex: %s prevIndex: %s lastIndex: %s nextToSendIdx: %s', nextIndexm, prevIndex, lastIndex, nextToSendIdx);
    ...
    debug('pipe after: nextIndex: %s prevIndex: %s lastIndex: %s nextToSendIdx: %s queue.length: %s', nextIndexm, prevIndex, lastIndex, nextToSendIdx, queue.length);
