...
class RaftPersistence extends FilePersistence {
  ...
  **/
  constructor(filename, initPeers) {
    super(filename, {currentTerm: 0, votedFor: null, peers: initPeers, peersUpdateRequest: null});
  }

  [Symbol.for('apply')]({currentTerm, votedFor, peers, peersUpdateRequest}) {
  ...
  [Symbol.for('validate')]({currentTerm, votedFor, peers, peersUpdateRequest}, withAllProperties) {
    var data = {};
