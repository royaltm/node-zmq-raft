...
, MAX_LOG_ENTRY_DATA_SIZE: 10*1024*1024 /* 10MB */
  ...
  /* send this max size chunk of snapshot data */
, INSTALL_SNAPSHOT_SEND_DATA_MAX: 64*1024
...
, REQUEST_ENTRIES_HIGH_WATERMARK: 8000
  /* 5 seconds, how log (+ up to 2 seconds) to wait between client requests before canceling stream */
, REQUEST_ENTRIES_TTL: 5*1000
  /* how many "packets" of entries send in advance before the next request comes */
